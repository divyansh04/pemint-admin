...
class Partnership_PVT extends StatefulWidget {
  const Partnership_PVT({Key? key}) : super(key: key);

  @override
  State<Partnership_PVT> createState() => _Partnership_PVTState();
}

class _Partnership_PVTState extends State<Partnership_PVT> {
                            ...
                            children: [
                              ...
                              GestureDetector(
                                  onTap: () {
                                    controller.selectfile(
                                        fileName:
                                            controller.authorizationLetter,
                                        fileKey: 'AuthorizationLetter');
                                  },
                                  child: Container(
                                    height: 30,
                                    width: 80,
